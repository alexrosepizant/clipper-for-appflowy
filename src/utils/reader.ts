...
export class Reader {
	...
	private static injectSettingsBar(doc: Document) {
		...
		const appflowyIcon = doc.createElementNS(
			"http://www.w3.org/2000/svg",
			"svg"
		);
		appflowyIcon.setAttribute("width", "18");
		appflowyIcon.setAttribute("height", "18");
		appflowyIcon.setAttribute("viewBox", "0 0 128 128");
		appflowyIcon.setAttribute("fill", "currentColor");
		appflowyIcon.innerHTML =
		...
		addToObsidianBtn.appendChild(appflowyIcon);
